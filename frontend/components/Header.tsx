            ...
            {isMenuOpen && (
                <nav className="bg-white md:hidden">
                    <ul className="space-y-2 p-4">
                        <li><Link href="/" className="path block text-gray-600 transition-colors duration-300"
                               onClick={() => setIsMenuOpen(false)}>Home</Link></li>
                        <li><Link href="/explorer" className="path block text-gray-600 transition-colors duration-300"
                               onClick={() => setIsMenuOpen(false)}>Explorer</Link></li>
                        <li><Link href="/account" className="path block text-gray-600 transition-colors duration-300"
