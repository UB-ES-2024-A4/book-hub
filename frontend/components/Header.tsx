        ...
        <header className="bg-white shadow-md fixed top-0 left-0 right-0 z-10">
            <div className="container mx-auto flex justify-between items-center p-4">
                ...
                <nav className="hidden md:flex space-x-8 items-center">
                    ...
                    <Link href="/auth/sign-in" className="text-white bg-[#4066cf] px-4 py-2 rounded-md shadow-md transition duration-300 hover:bg-[#3050a6]">Sign In</Link>
                    <Link href="/auth/sign-up" className="text-white bg-green-500 px-4 py-2 rounded-md shadow-md transition duration-300 hover:bg-green-600">Sign Up</Link>
                </nav>
            ...
            {isMenuOpen && (
                <nav className="bg-white md:hidden">
                    <ul className="space-y-2 p-4">
                        <li><Link href="/" className="path block text-gray-600 transition-colors duration-300" onClick={() => setIsMenuOpen(false)}>Home</Link></li>
